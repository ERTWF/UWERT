...
async def start_(client: Client, message: Message):
 ...
 هلا عمري {message.from_user.mention()} !
  ...
  بصوت رائع وبدون اي مشاكل او تقطيع في الاغنيه
 اضفني الى مجموعتك وامنحني الصلاحيات لكي اعمل 
┏━━━━━━━━━━━━━━┓
┣★ نشكر كل مين اضاف 
┣★ [مطور البوت](t.me/{me})
...
┗━━━━━━━━━━━━━━┛
 ...
 لمعرفة اوامر هذا البوت اضغط على زر الاوامر ان واجهة مشكلة تواصل مالك السورس [𝐒𝐈𝐅 𝐂𝐎𝐁𝐑𝐀](t.me/QABNADLIB
━━━━━━━━━━━━━━━━━━**""",
